...
require_once dirname( __FILE__ ) . "/classes/class-ftp-" . ( $mod_sockets ? "sockets" : "pure" ) . ".php";

if ( $mod_sockets ) {
	class wordpatch_ftp extends wordpatch_ftp_sockets {}
} else {
	class wordpatch_ftp extends wordpatch_ftp_pure {}
}
